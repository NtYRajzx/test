...
% tmp_row_abs_sum = zeros(num_user,num_user,num_irs_elements);
% for kk=1:num_user
%     for jj=1:num_user
%         for ii=1:num_samples
%             tmp_row_abs_sum(kk,jj,:) = tmp_row_abs_sum(kk,jj)+abs(channel_cascaded(ii,jj,:,kk));
%         end
%         
%     end
% end
