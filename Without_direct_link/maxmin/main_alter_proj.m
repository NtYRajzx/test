...
%             load A.mat
            ...
            [v,obj_tmp] = alter_proj_maxmin(A,sigma2_dB);
            %min rate
...
%             prob_tmp = prob_tmp+(tmp_interference<1e-4)*1.0;
        ...
        file_name = sprintf('./results/Gaussian_alter_k%d_%d.mat',num_user,ts)
        save(file_name,'sigma2_dB_set', 'num_elements_irs_set', 'rate_set');
    end    
end
